...
public class RentACatUnitTest {
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse(ret);
		// is the below legal??
		Mockito.verify(c2, times(0)).renameCat("Garfield"); // legal??
		assertEquals("Invalid cat ID.\n", out.toString());
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		assertEquals(out.toString(), "Sorry, Old Deuteronomy is not here!\n");
	...
	public void testReturnCatNumCats3() {
		...
		assertEquals(out.toString(), "Welcome back, Old Deuteronomy!\n");
	}
